          ...
          <Col lg={12} xs={24} sm={24}>
            ...
            <div className="flex flex-col gap-2">
              ...
              <h1 className="text-2xl mt-2">
                Fare : Rs {bus.fare * selectedSeats.length} /-
              </h1>
              <hr />
              ...
              <StripeCheckout
                ...
                currency="INR"
                stripeKey="pk_test_51LrZFaSC2ofiOBBZiPjU6daJxpPIMdtxGvhVwg2CO0Bnsb3QyppEDr6Y7e8y4jH8XaNooqDAdfAgRx4GbU7SwDIB00YLuF9DlR"
              >
                <button
